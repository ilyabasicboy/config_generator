    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bundle_id', models.CharField(blank=True, max_length=255, null=True, verbose_name='id приложения в appstore')),
                ('push_bundle_id', models.CharField(blank=True, max_length=255, null=True, verbose_name='id пуш экстеншена в appstore')),
            ...
            options={
                'verbose_name': 'Whitelabel config',
                'verbose_name_plural': 'Whitelabel configs',
            },
        ),
        migrations.CreateModel(
            name='WhiteLabel',
